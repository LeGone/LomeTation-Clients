...
(function () {
	...
	var SPARKLINE_COLORS = ["#9fda58", "#FFFFFF", "#B3B4B4", "#6B6B6B", "#28DE28", "#13F7F9", "#E6EE18", "#C41204", "#CA3CB8", "#0B1CFB"];
	...
	freeboard.addStyle('.indicator-light.on', "background-color:#FFC773;box-shadow: 0px 0px 15px #9fda58;border-color:#FDF1DF;");
